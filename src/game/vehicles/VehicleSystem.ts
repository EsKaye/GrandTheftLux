...
export class VehicleSystem {
  ...
  private initializeTemplates(): void {
    ...
    this.vehicleTemplates.set(VehicleType.SPORTS_CAR, {
      ...
      transmission: {
        type: "manual",
        gears: 6,
        gearRatios: [3.5, 2.5, 1.8, 1.4, 1.1, 0.9],
      },
      suspension: {
        type: "independent",
        stiffness: 0.8,
      ...
      tires: {
        ...
        grip: 0.9,
        wear: 0.3,
        size: { width: 245, aspect: 40, diameter: 18 },
      },
      price: 75000,
      rarity: "rare",
    });
    ...
    this.vehicleTemplates.set(VehicleType.SEDAN, {
      ...
      transmission: {
        type: "automatic",
        gears: 6,
        gearRatios: [3.2, 2.1, 1.5, 1.1, 0.8, 0.6],
      },
      suspension: {
        type: "independent",
        stiffness: 0.6,
      ...
      tires: {
        ...
        grip: 0.7,
        wear: 0.2,
        size: { width: 215, aspect: 55, diameter: 17 },
      },
      price: 35000,
      rarity: "common",
    });
    ...
    this.vehicleTemplates.set(VehicleType.SUV, {
      ...
      transmission: {
        type: "automatic",
        gears: 8,
        gearRatios: [4.7, 3.1, 2.1, 1.5, 1.1, 0.8, 0.6, 0.5],
      },
      suspension: {
        type: "independent",
        stiffness: 0.5,
      ...
      tires: {
        ...
        grip: 0.6,
        wear: 0.25,
        size: { width: 235, aspect: 65, diameter: 18 },
      },
      price: 45000,
      rarity: "common",
    });
    ...
    this.vehicleTemplates.set(VehicleType.MOTORCYCLE, {
      ...
      transmission: {
        type: "manual",
        gears: 6,
        gearRatios: [3.0, 2.0, 1.5, 1.2, 1.0, 0.9],
      },
      suspension: {
        type: "telescopic",
        stiffness: 0.7,
      ...
      tires: {
        ...
        grip: 0.85,
        wear: 0.4,
        size: { width: 180, aspect: 55, diameter: 17 },
      },
      price: 25000,
      rarity: "uncommon",
    });

    // Arcane Bike unlocked via Leyline Drift
    this.vehicleTemplates.set("vehicle_arcane_bike" as unknown as VehicleType, {
      id: "vehicle_arcane_bike",
      name: "Arcane Bike",
      type: VehicleType.MOTORCYCLE,
      class: VehicleClass.MOTORCYCLE,
      mass: 380,
      ...
      handling: 0.97,
      braking: 0.92,
      dimensions: { length: 2.1, width: 0.7, height: 1.3 },
      engine: { power: 180, torque: 150, redline: 13000, fuelType: "gasoline" },
      transmission: {
        type: "manual",
        gears: 6,
        gearRatios: [3.1, 2.2, 1.6, 1.3, 1.0, 0.9],
      },
      suspension: {
        type: "telescopic",
        stiffness: 0.8,
      ...
      tires: {
        ...
        grip: 0.9,
        wear: 0.35,
        size: { width: 190, aspect: 50, diameter: 17 },
      },
      price: 45000,
      rarity: "rare",
      sigils: ["celerity"],
    ...
    // Astral Car as ultimate reward
    this.vehicleTemplates.set("vehicle_astral_car" as unknown as VehicleType, {
      id: "vehicle_astral_car",
      name: "Astral Car",
      type: VehicleType.SPORTS_CAR,
      class: VehicleClass.SPORTS,
      mass: 1100,
      ...
      handling: 0.95,
      braking: 0.85,
      dimensions: { length: 4.4, width: 1.7, height: 1.2 },
      engine: { power: 400, torque: 420, redline: 9000, fuelType: "gasoline" },
      transmission: {
        type: "manual",
        gears: 6,
        gearRatios: [3.6, 2.6, 1.9, 1.5, 1.1, 0.95],
      },
      suspension: {
        type: "independent",
        stiffness: 0.85,
      ...
      tires: {
        ...
        grip: 0.95,
        wear: 0.3,
        size: { width: 255, aspect: 35, diameter: 19 },
      },
      price: 125000,
      rarity: "legendary",
      sigils: ["celerity", "aegis"],
    });
  }
  ...
  public createVehicle(
    ...
    vehicle.transform.rotation = Quaternion.fromEuler(
      rotation.x,
      rotation.y,
      rotation.z,
    );
  ...
  private setupTrafficSystem(): void {
    ...
    const trafficCount = Math.floor(
      this.config.maxVehicles * this.config.trafficDensity,
    );
